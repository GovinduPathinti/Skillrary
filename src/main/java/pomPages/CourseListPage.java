...
public class CourseListPage {
	...
	//A string variable deletePath is declared with a format string. This string is used 
	//to dynamically create an XPath expression to locate a "Delete" button associated with 
	//a specific course name in a table.
